...
Aiming to test the distances for points from the contour in the image
*/
...
int main(int argc, char** argv)
{
	...
	findContours(src_copy,contours,hierarchy,CV_RETR_TREE,CV_CHAIN_APPROX_SIMPLE);
